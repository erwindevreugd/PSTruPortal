<#
    .SYNOPSIS
    Gets multiple user defined fields or a single user defined field if an user defined field id is specified.
...
function Get-UserDefinedField {
    ...
    param (
        ...
        [Parameter(
            Mandatory=$false,
            ValueFromPipelineByPropertyName=$true,
            HelpMessage="The id of the user defined field."
        )]
    ...
    process {
        $endPoint       = "api/userDefinedFields"
        $method         = "GET"
